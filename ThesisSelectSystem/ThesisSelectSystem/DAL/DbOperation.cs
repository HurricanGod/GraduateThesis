...
namespace ThesisSelectSystem.DAL
{
    public class DbOperation
    {
        ...
        /// <summary>
        /// 根据整型主键查询数据，返回一个指定类型的实体对象
        /// </summary>
        /// <param name="returnType">全类名，用于指定查询结果要封装到的类里</param>
        /// <param name="id">要查询表的主键值</param>
        /// <param name="tableName">要查询的表名</param>
        /// <returns>参数returnType指定类型的对象</returns>
        public static Object QueryById(Type returnType, int id, string tableName)
        {
            Object itemEntity = null;
            try
            {
